//
// Created by arthur on 08/01/2025.
//

#ifndef CCT_DOTNET_STATUS_CODEHPP
#define CCT_DOTNET_STATUS_CODEHPP
...
namespace cct::dotnet
{
	...
	using StatusCodeUnderlyingType = std::underlying_type_t<StatusCode>;
} // namespace cct::dotnet


#endif //CCT_DOTNET_STATUS_CODEHPP
